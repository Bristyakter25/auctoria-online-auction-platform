...
const Testimonials = () => {
  return (
    <div
      className="lg:w-[1224px] mb-10 mt-24 w-[350px] rounded-lg mx-auto px-4 py-16 sm:px-6 lg:px-8 text-gray-800 dark:text-white"
      style={{
        backgroundImage:
    ...
    >
      <h2 className="text-3xl font-bold text-center mb-6">What Client's Say</h2>
      ...
      >
        {[
          {
            name: 'Johan Martin',
            role: 'CEO',
            image: 'https://www.bidout-wp.egenslab.com/wp-content/uploads/2022/10/testi3.png',
          ...
          },
          {
            name: 'Jamie Anderson',
            role: 'Manager',
            image: 'https://www.bidout-wp.egenslab.com/wp-content/uploads/2022/10/testi1.png',
          ...
          },
          {
            name: 'John Peter',
            role: 'Area Manager',
            image: 'https://www.bidout-wp.egenslab.com/wp-content/uploads/2022/10/testi2.png',
        ...
        ].flatMap((item) => [item, item]).map((testimonial, idx) => (
          <SwiperSlide key={idx}>
            <div className="bg-white h-[400px] dark:bg-gray-800 p-6 rounded-lg shadow-md flex flex-col items-center text-center transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
              ...
              />
              <p className="text-gray-600 h-[150px] dark:text-gray-300 italic mb-4">{testimonial.text}</p>
