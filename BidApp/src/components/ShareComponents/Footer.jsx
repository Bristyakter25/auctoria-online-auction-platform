  ...
  return (
    <footer className="relative bg-gray-700 dark:bg-gray-900 text-white mt-24 overflow-hidden px-10 py-7">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 z-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300">
            Your one-stop destination for all things — auctions and deals. Find
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li>
              <Link to="/contact-home" className="hover:text-white transition">
                Contact
              </Link>
            </li>
          </ul>
      ...
      <div className="text-center text-sm text-gray-400 mt-6">
        ...
        <span className="font-semibold text-white">Auctoria</span>. All rights
        reserved.
      </div>
    </footer>
  );
