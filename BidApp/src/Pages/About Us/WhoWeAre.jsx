   ...
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div className="px-4">
     ...
     <div className="flex items-start mb-6">
      ...
      <div>
       <h3 className="text-xl font-semibold  mb-2">Our Expert Solutions</h3>
       <p className="">Praesent gravida nunc at tortor cursus, molestie dapibus purus posuere. Vestibulum commodo, massa eget rutrum feugiat.</p>
      </div>
     </div>
     ...
     <div className="flex items-start mb-6">
      ...
      <div>
       <h3 className="text-xl font-semibold  mb-2">Trusted Performance</h3>
       <p className="">Praesent gravida nunc at tortor cursus, molestie dapibus purus posuere. Vestibulum commodo, massa eget rutrum feugiat.</p>
      </div>
     </div>
     ...
     <div className="flex items-start">
      ...
      <div>
       <h3 className="text-xl font-semibold  mb-2">Experience the Difference</h3>
       <p className="">Praesent gravida nunc at tortor cursus, molestie dapibus purus posuere. Vestibulum commodo, massa eget rutrum feugiat.</p>
      </div>
     </div>
    </div>
