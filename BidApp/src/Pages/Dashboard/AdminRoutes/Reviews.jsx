...
const fetchReviews = async () => {
  const response = await axios.get("hhttp://localhost:5000/reviews");
...
const Reviews = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`hhttp://localhost:5000/reviews/${id}`);
  ...
  const submitReply = async () => {
    ...
    try {
      await axios.patch(
        `hhttp://localhost:5000/reviews/${replyModal.reviewId}`,
        {
